...
class TestTpRatio(unittest.TestCase):
    def setUp(self):
        self._mods = []
        def add(name, mod):
        ...
        os.environ["ATR_SL_MULTIPLIER"] = "1.0"
    ...
    def test_tp_scaled_by_ratio(self):
        ...
        self.assertAlmostEqual(self.el.order_manager.last_params["sl_pips"], 6.0)
