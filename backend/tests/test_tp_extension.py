...
class TestTpExtension(unittest.TestCase):
    def setUp(self):
        ...
        os.environ["TP_EXTENSION_ENABLED"] = "true"
        os.environ["TP_EXTENSION_ADX_MIN"] = "25"
        os.environ["TP_EXTENSION_ATR_MULT"] = "2"
    ...
    def test_tp_extension_called(self):
        pos = {
            "instrument": "USD_JPY",
            "long": {"units": "1", "averagePrice": "1.0", "tradeIDs": ["t1"]},
            "unrealizedPL": "0"
        }
        indicators = {"adx": FakeSeries([30]), "atr": FakeSeries([0.1])}
        self.runner.tp_extended = False
        self.runner._maybe_extend_tp(pos, indicators, "long", 0.01)
        ...
        self.assertAlmostEqual(new_tp, 1.2)
